...
const std::vector<td::td_api::object_ptr<td::td_api::chatFolderInfo>> &StorageManager::getChatFolders() const noexcept
{
    ...
    td::td_api::downcast_call(
        *object,
        detail::Overloaded{
            ...
            [this](td::td_api::updateChatFolders &value) { m_chatFolders = std::move(value.chat_folders_); },
