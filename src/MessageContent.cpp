...
MessageSticker::MessageSticker(td::td_api::object_ptr<td::td_api::messageSticker> content, QObject *parent)
    : QObject(parent)
{
    m_isPremium = content->is_premium_;
...
MessageAnimatedEmoji::MessageAnimatedEmoji(td::td_api::object_ptr<td::td_api::messageAnimatedEmoji> content, QObject *parent)
    : QObject(parent)
{
    // m_animatedEmoji = QString::fromStdString(content->animated_emoji_->sticker_->file_name_);
    ...
    : QObject(parent)
{
    ...
    // m_discardReason = QString::fromStdString(content->discard_reason_->description_);
    ...
    : QObject(parent)
{
    switch (content->get_id())
    {
        ...
        case td::td_api::messageBasicGroupChatCreate::ID: {
            ...
            {
                m_addedMembers += QString::number(member) + ", ";
            }
            break;
        }
        ...
        case td::td_api::messageChatSetMessageAutoDeleteTime::ID: {
            ...
            // m_autoDeleteTime = QString::number(message->auto_delete_time_);
            break;
        }
...
QString MessageService::addedMembers() const
{
    return m_addedMembers;
}

QString MessageService::removedMember() const
{
    return m_removedMember;
}

QString MessageService::upgradedToSupergroup() const
{
    return m_upgradedToSupergroup;
}

QString MessageService::upgradedFromGroup() const
{
    return m_upgradedFromGroup;
}

QString MessageService::pinnedMessage() const
{
...
QString MessageService::autoDeleteTime() const
{
